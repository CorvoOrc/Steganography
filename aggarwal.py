...
name = 'lena.png'  # raw_input('Input path to image:')
...
name = 'first.tif'  # raw_input('Enter primary WM:')
...
name = 'second.bmp'  # raw_input('Enter secondary WM')
...
if fg == 'S':
    nestedArray = numpy.array(nestedWM)
else:
...
print 'PSNR:{psnr}\nMSE:{mse}\nSR:{sr}'.format(psnr=psnr, mse=mse, sr=sr)
